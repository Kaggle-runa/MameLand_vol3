locals {
  service_account_email = "data-pipeline@focal-acronym-381707.iam.gserviceaccount.com"
}
...
resource "google_monitoring_alert_policy" "alert_policy-race_plan" {
  ...
  notification_channels = ["projects/focal-acronym-381707/notificationChannels/16917657569040275364"]
  alert_strategy {
    auto_close = "604800s"
